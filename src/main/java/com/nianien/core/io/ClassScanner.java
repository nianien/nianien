...
public class ClassScanner {
    ...
    public ClassScanner(ClassFilter classFilter) {
        this(classFilter, Thread.currentThread().getContextClassLoader());
    }
     ...
     * @param classLoader
     */
    public ClassScanner(ClassFilter classFilter, ClassLoader classLoader) {
    ...
    private void loadClass(String className, Collection<Class> classes) {
        try {
            ...
            if (classFilter.accept(targetClass)) {
