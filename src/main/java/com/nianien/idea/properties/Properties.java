package com.nianien.idea.properties;
...
public class Properties {
	...
	private void loaFile(String fileName) {
		if (".xml".equalsIgnoreCase(Files.getFileExt(fileName))) {
			...
			Map<Object, Object> pros = PropertiesLoader.load(fileName);
	...
	private String getPackageLeader(String packageName) {
		return packageName = StringUtils.isEmpty(packageName) ? "" : packageName
				+ ".";
	}
